...
import com.example.multigaming.SnakeHelper.DrawControl;
import com.example.multigaming.SnakeHelper.SnakeMovement;
...
public class SnakeView extends SurfaceView implements Runnable {
    ...
    private AppConstants.Direction m_Direction = AppConstants.Direction.RIGHT;
    ...
    //Control
    private AppConstants.Control m_Control = AppConstants.Control.POV;
    ...
    public void updateGame() {
        ...
        if (detectDeath()) {
            ...
            ((com.example.multigaming.SnakeActivity) m_context).finish();
